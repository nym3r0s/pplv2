...
mysql_result($res,0,"strikeRate");
    ...
    $res = mysqli_query($link,$query);
    $wickets = 
mysql_result($res,0,"wickets");

    $query = 'SELECT `economy` FROM `bowling` WHERE playerId='.$id.'';
    $res = mysqli_query($link,$query);
    $economy = 
mysql_result($res,0,"economy");
    ...
    $res = mysqli_query($link,$query);
    $catches = 
mysql_result($res,0,"catches");

    $query = 'SELECT `stumpings` FROM `fielding` WHERE playerId='.$id.'';
    $res = mysqli_query($link,$query);
    $stumpings = 
mysql_result($res,0,"stumpings");
