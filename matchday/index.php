      ...
      <div class="container">
        ...
        <div id="navbar" class="collapse navbar-collapse">
          <ul class="nav navbar-nav">
            ...
            <li class="active"><a href="../matchday/">Matchday</a></li>
...
else
{
    ...
    $confirmedListResult = mysqli_query($link,$confirmedListQuery);
    if(mysqli_num_rows($confirmedListResult)!=0)
    {
        $anyPlayers = true;
    }
    if($anyPlayers)
...
EOT;
    ...
    for($i=0;$i<mysqli_num_rows($confirmedListResult);$i++)
    {
            $playerId    = 
mysql_result($confirmedListResult,$i,"playerId");
